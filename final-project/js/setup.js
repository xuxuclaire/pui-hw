...
let professions = ["Product Designer", "Data Scientist", "Software Engineer", "Product Manager", "UX Designer", "UX Researcher"]
...
function startPracticing(){
    ...
    //practice amount check
    if(inputAmount > 12 || inputAmount < 1){
    ...
    if ((professions.indexOf(inputProfession) != -1) && (inputAmount <= 12 || inputAmount >= 1)){
                //store user input
